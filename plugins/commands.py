...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/YearnCash_CoinDraft_News'),
            InlineKeyboardButton('🧩 Source', url='https://t.me/YearnCash_CoinDraft_News')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://t.me/YearnCash_CoinDraft_News'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/YearnCash_CoinDraft_News'),     
        ],
        [
